            ...
            if (not skip and type(paper['dblpkey']) is str and type(paper['ee']) is str) and \
                ...
                if skip is False:
                    ...
                    if pub_info is None:
                        ...
                        try:
                            req = Request(paper['ee'], headers={'User-Agent': ua.random})
                            ...
                            rndm_time = int(random.uniform(6, 60))
                            print(
                    ...
                    try:
                        ...
                        if skipped:
                            ...
                            if self.storeToMongo:
                                ...
                                #################################################                       
                                if 'Biom' in paper['journal']:                   #
                                    paper['domain'] = 'Biomedical'              #
                                if 'Robo' in paper['journal']:                  #
                                    paper['domain'] = 'Robotics'                #
                                ################################################# 
