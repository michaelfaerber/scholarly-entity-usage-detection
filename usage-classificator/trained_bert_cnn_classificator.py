...
checkpoints = list(sorted(glob.glob(os.path.join("output_bert", "checkpointepoch=*.ckpt"), recursive=True)))
bert_model = Transformer.load_from_checkpoint(checkpoints[-1], model_path=os.path.join("output_bert", "best_tfmr/pytorch_model.bin"))
